...
SECRET_KEY = 'django-insecure-$=n&m9-64)j3+!j+9l1fc#kr_s(xv%n4f0r+ze%xusagp7b746'
...
# Sirve para indicar a DJANGO que modelo de usuario tiene q utilizar en vez del original
...
SIMPLE_JWT = {
    ...
    'ACCESS_TOKEN_LIFETIME' : timedelta(hours=1,minutes=11, seconds=5)
}

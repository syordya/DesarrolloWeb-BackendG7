...
import {getDepartamentos, postDepartamento, updateDepartamento, deleteDepartamento,devolverDepartamento} from "../controllers/departamentos.controllers.js";


export const departamentosRouter=Router();

departamentosRouter.route("/departamentos")
